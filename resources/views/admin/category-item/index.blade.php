    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header justify-content-between d-flex d-inline">
          <h4 class="card-title"> Kategori Item</h4>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable">
              ...
              <tbody>
                  ...
                  <tr>
                      <td>{{ $i++ }}</td>
                      <td>{{ $category->category_item }}</td>
                      <td>
                          <a href="#" data-id="{{ $category->id }}" data-name="{{ $category->category_item }}" data-toggle="modal" data-target="#edit"><i class="fas fa-edit"></i></a>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.category-item.update') }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="category_item" required>
                        @error('name')
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.category-item.delete') }}" method="POST">
                @csrf
                @method('delete')
                <input type="hidden" name="id">
                <div class="modal-header">
...
<script>
    $("#edit").on('show.bs.modal', (e) => {
        ...
        $('#edit').find('input[name="category_item"]').val(name);
    });
